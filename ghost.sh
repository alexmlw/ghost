...
with SYSGHOST			"$HOME/ghost/sysghost"
...
SYSGHOST_APPLICATIONS=$SYSGHOST/applications
SYSGHOST_SYSTEM=$SYSGHOST/system
SYSGHOST_SYSTEM_INCLUDE=$SYSGHOST_SYSTEM/include
SYSGHOST_SYSTEM_LIB=$SYSGHOST_SYSTEM/lib
